...
import {
  IconLayoutDashboard, IconUsers, IconCalendar, IconListNumbers,
  IconBell, IconLogout, IconMenu2, IconX
...
const NAV = [
  { to: '/counselor/dashboard', icon: IconLayoutDashboard, label: 'Dashboard' },
  { to: '/counselor/students', icon: IconUsers, label: 'Students' },
  { to: '/counselor/sessions', icon: IconCalendar, label: 'Sessions' },
  { to: '/counselor/pref-lists', icon: IconListNumbers, label: 'Pref Lists' },
  { to: '/counselor/notifications', icon: IconBell, label: 'Notifications' },
]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-blue-300 text-[11px]">Excellence is our Identity</p>
              </div>
            </div>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-30 bg-[#1a1f36] flex items-center px-4 h-14 gap-3">
        ...
        <button onClick={() => navigate('/counselor/notifications')} className="relative w-9 h-9 flex items-center justify-center text-white">
          <IconBell size={20} />
          {unreadCount > 0 && (
